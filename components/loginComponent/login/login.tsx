  ...
  return (
          ...
          <div className="w-72 my-4">
            <div className="relative h-10 w-full min-w-[200px]">
                ...
                <div onClick={()=> setShowPass(!showPass)} className="absolute top-2 right-2 cursor-pointer">
                {showPass?
                  <Image width={24} height={24} src='./assets/icons/eye.svg' alt="eye"/>
                  :
                  <Image width={24} height={24} src='./assets/icons/eye-off.svg' alt="eye-off"/>
                }
                </div>
            </div>
          </div>
